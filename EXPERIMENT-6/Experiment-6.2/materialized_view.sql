...
--MATERIALIZED VIEW
CREATE MATERIALIZED VIEW EMP_KRG_601B_MAT
AS
SELECT EMP_ID,EMP_NAME FROM EMPLOYEES
WITH NO DATA

SELECT * FROM EMP_KRG_601B_MAT 
--materialized view "emp_krg_601b_mat" has not been populated

REFRESH MATERIALIZED VIEW EMP_KRG_601B_MAT 
